...
> Extensión posterior completada: el registro transaccional de cambios de
> entidades críticas se documenta en
> `docs/entity-change-logging.md`, incluyendo el plan de adopción para nuevos
> agregados. Este mecanismo complementa, y no reemplaza, la auditoría de
> acciones.
