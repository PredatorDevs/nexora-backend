...
export function createExpenseTypesController(service, auditService) {
  ...
  return {
    async list(request, response) {
      ...
      return sendSuccess(response, result.expenseTypes, {
    ...
    async create(request, response) {
      return sendSuccess(
        ...
        await audited(
          request,
          {
            action: auditActions.expenseTypeCreated,
    ...
    async update(request, response) {
      return sendSuccess(
        ...
        await audited(
          request,
          {
            action: auditActions.expenseTypeUpdated,
    ...
    async changeStatus(request, response) {
      return sendSuccess(
        ...
        await audited(
          request,
          {
            action: auditActions.expenseTypeStatusChanged,
            resourceId: request.validated.params.id,
          },
          () =>
