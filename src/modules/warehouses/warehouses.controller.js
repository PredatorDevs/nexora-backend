...
export function createWarehousesController(service, auditService) {
  ...
  return {
    async list(request, response) {
      ...
      return sendSuccess(response, result.warehouses, { meta: { pagination: result.pagination } });
    },
    ...
    async create(request, response) {
      return sendSuccess(response, await audited(request, {
        action: auditActions.warehouseCreated,
    ...
    async update(request, response) {
      return sendSuccess(response, await audited(request, {
        action: auditActions.warehouseUpdated,
    ...
    async changeStatus(request, response) {
      return sendSuccess(response, await audited(request, {
        action: auditActions.warehouseStatusChanged,
        resourceId: request.validated.params.id,
